...
class RealisasilpseController extends Controller
{
    public function index()
    {
        ...
        return view('realisasilpse.index', compact(
            'breadcrumb',
            'page',
            'activeMenu',
            'program',
    ...
    public function create()
    {
        ...
        return view('realisasilpse.create', compact('breadcrumb', 'page', 'activeMenu', 'listProgram'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('realisasilpse.index')
