                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action ml-2">
                            <button onclick="modalAction(`{{ url('/master_rekening/import') }}`)" class="btn btn-info"
                                style="background-color: #EF5428; border-color: #EF5428;"> <i
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped dt-responsive nowrap"
                                id="table_master_rekening" style="width:100%">
        ...
        $(document).ready(function() {
            ...
            $('#kegiatan_filter').on('change', function() {
                ...
                if (kegiatanId) {
                    ...
                    $.ajax({
                        url: "{{ url('/master_rekening/kegiatan') }}/" + kegiatanId +
                            "/sub_kegiatan",
                        type: 'GET',
                        dataType: 'json',
                        success: function(data) {
                            ...
                            $.each(data, function(index, subKegiatan) {
                                ...
                                $('#sub_kegiatan_filter').append('<option value="' +
                                    subKegiatan.id_sub_kegiatan + '">' + subKegiatan
