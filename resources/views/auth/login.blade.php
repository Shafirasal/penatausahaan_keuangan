...
<head>
    ...
    <style>
        ...
        .content-section {
            padding: 80px 0;
            background: #fff;
            /* Memberi background putih pada section */
        }
        ...
        .tentang-text-card h2 {
            font-weight: 600;
        }

        .tentang-text-card h5 {
            font-size: 20px;
            font-weight: 600;
            color: #a7283d;
        }
        ...
        .footer-section {
            ...
            /* Warna dasar biru gelap */
            color: #EAEAEA;
            /* Warna teks putih keabuan, lebih nyaman di mata */
            padding: 80px 0;
        }

        .footer-section h5 {
            color: #FFFFFF;
            /* Warna judul dibuat sedikit lebih terang */
            margin-bottom: 20px;
            font-weight: 600;
        ...
        .footer-section .contact-list i {
            ...
            margin-right: 12px;
            width: 20px;
            /* Memberi lebar tetap agar teks rata */
            text-align: center;
        }
                ...
                <nav>
                    <ul class="nav">
                        <li class="nav-item"><a href="#" class="nav-link"
                                data-scroll-to="#pelayanan">Pelayanan</a></li>
                        <li class="nav-item"><a href="#" class="nav-link" data-scroll-to="#kontak">Kontak</a></li>
                        <li class="nav-item"><a href="#" class="nav-link" data-scroll-to="#tentang">Tentang</a>
                        </li>
                    </ul>
                </nav>
            </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up">
                        <div class="custom-card h-100">
                            <div class="text-center">
                                ...
                                <p class="text-muted card-description">Membantu proses pengadaan barang dan jasa secara
                                    efisien, transparan, dan akuntabel.</p>
                            </div>
                            ...
                            <div class="realisasi-info mt-4">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <strong class="text-dark">Rp
                                        {{ number_format($dataBagian['pbj']['pagu'], 0, ',', '.') }}</strong>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <span class="text-muted small">Realisasi:</span>
                                    <strong class="text-success">Rp
                                        {{ number_format($dataBagian['pbj']['realisasi'], 0, ',', '.') }}</strong>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="text-muted small">Selisih:</span>
                                    <strong class="text-danger">Rp
                                        {{ number_format($dataBagian['pbj']['selisih'], 0, ',', '.') }}</strong>
                                </div>
                            </div>
                            ...
                            <div class="progress mt-3" style="height: 12px; border-radius: 10px;">
                                <div class="progress-bar bg-success progress-bar-striped progress-bar-animated"
                                    ...
                                    data-target="{{ $dataBagian['pbj']['persentase'] }}" aria-valuenow="0"
                    ...
                    <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="custom-card h-100">
                            <div class="text-center">
                                ...
                                <p class="text-muted card-description">Menyediakan layanan pengadaan secara elektronik
                                    untuk kemudahan dan jangkauan yang lebih luas.</p>
                            </div>
                            ...
                            <div class="realisasi-info mt-4">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <span class="text-muted small">Total Pagu:</span>
                                    <strong class="text-dark">Rp
                                        {{ number_format($dataBagian['lpse']['pagu'], 0, ',', '.') }}</strong>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <span class="text-muted small">Realisasi:</span>
                                    <strong class="text-info">Rp
                                        {{ number_format($dataBagian['lpse']['realisasi'], 0, ',', '.') }}</strong>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="text-muted small">Selisih:</span>
                                    <strong class="text-danger">Rp
                                        {{ number_format($dataBagian['lpse']['selisih'], 0, ',', '.') }}</strong>
                                </div>
                            </div>
                            ...
                            <div class="progress mt-3" style="height: 12px; border-radius: 10px;">
                                <div class="progress-bar bg-info progress-bar-striped progress-bar-animated"
                                    role="progressbar" style="width: 0%"
                                    data-target="{{ $dataBagian['lpse']['persentase'] }}" aria-valuenow="0"
                                    aria-valuemin="0" aria-valuemax="100">
                                </div>
                            </div>
                            <div class="text-center mt-2">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="200">
                        <div class="custom-card h-100">
                            <div class="text-center">
                                ...
                                <p class="text-muted card-description">Memberikan pembinaan dan advokasi untuk
                                    meningkatkan kompetensi sumber daya manusia.</p>
                            </div>
                            ...
                            <div class="realisasi-info mt-4">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <span class="text-muted small">Total Pagu:</span>
                                    <strong class="text-dark">Rp
                                        {{ number_format($dataBagian['pembinaan']['pagu'], 0, ',', '.') }}</strong>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <span class="text-muted small">Realisasi:</span>
                                    <strong class="text-warning">Rp
                                        {{ number_format($dataBagian['pembinaan']['realisasi'], 0, ',', '.') }}</strong>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="text-muted small">Selisih:</span>
                                    <strong class="text-danger">Rp
                                        {{ number_format($dataBagian['pembinaan']['selisih'], 0, ',', '.') }}</strong>
                                </div>
                            </div>
                            ...
                            <div class="progress mt-3" style="height: 12px; border-radius: 10px;">
                                <div class="progress-bar bg-warning progress-bar-striped progress-bar-animated"
                                    role="progressbar" style="width: 0%"
                                    data-target="{{ $dataBagian['pembinaan']['persentase'] }}" aria-valuenow="0"
                                    aria-valuemin="0" aria-valuemax="100">
                                </div>
                            </div>
                            <div class="text-center mt-2">
                                    ...
                                    <div class="col-md-3 col-6">
                                        <div class="stat-box">
                                            ...
                                            <h4 class="mb-0 fw-bold">Rp
                                                {{ number_format($totalKeseluruhan['pagu'], 0, ',', '.') }}</h4>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-6">
                                        <div class="stat-box">
                                            ...
                                            <h4 class="mb-0 fw-bold">Rp
                                                {{ number_format($totalKeseluruhan['realisasi'], 0, ',', '.') }}</h4>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-6">
                                        <div class="stat-box">
                                            ...
                                            <h4 class="mb-0 fw-bold">Rp
                                                {{ number_format($totalKeseluruhan['selisih'], 0, ',', '.') }}</h4>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-6">
                                        <div class="stat-box">
                                            ...
                                            <h4 class="mb-0 fw-bold">
                                                {{ number_format($totalKeseluruhan['persentase'], 2, ',', '.') }}%</h4>
                                        </div>
                                    </div>
                                </div>

                                <div class="progress mt-4"
                                    style="height: 15px; background-color: rgba(255,255,255,0.2); border-radius: 10px;">
                                    <div class="progress-bar bg-light progress-bar-striped progress-bar-animated"
                                        role="progressbar" style="width: 0%"
                                        data-target="{{ $totalKeseluruhan['persentase'] }}" aria-valuenow="0"
                                        aria-valuemin="0" aria-valuemax="100">
                ...
                <div class="row align-items-stretch">
                    <div class="col-md-6 mb-4 mb-md-0" data-aos="fade-right">
                        <div class="tentang-text-card">
                            ...
                            <div class="mb-4">
                                <h5>01. Visi</h5>
                                <p>Mewujudkan biro pengadaan barang/jasa yang profesional, transparan, dan akuntabel.
                                </p>
                            </div>
                            <div class="mb-4"
                                style="max-width: 700px; margin: 0 auto; line-height: 1.6; font-size: 16px; text-align: justify;">
                                <h5>02. Misi</h5>
                                <p>
                                    Melaksanakan proses pengadaan barang/jasa pemerintah yang efisien, efektif,
                                    transparan, keterbukaan, bersaing, adil/tidak diskriminatif, dan akuntabel untuk
                                    mewujudkan tata kelola pemerintahan yang baik dan bersih serta meningkatkan
                                    persaingan usaha yang sehat dalam layanan pengadaan barang/jasa pemerintah bagi
                                    masyarakat.
                                </p>
                            </div>
                            <div>
                    ...
                    <div class="col-md-6" data-aos="fade-left">
                        <div class="tentang-image-wrapper">
                            <img src="https://images.unsplash.com/photo-1556761175-5973dc0f32e7?q=80&w=2832&auto=format&fit=crop"
                                alt="Tentang Biro PBJ" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row gy-5 gx-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="d-flex">
                            ...
                            <p>
                                Jl. Pahlawan No.110 Lt. 3 dan Lt. 6, Krembangan Sel., Kec. Krembangan, Surabaya, Jawa
                                Timur 60175
                            </p>
                        </div>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function animateProgressBars() {
                ...
                progressBars.forEach(function(bar) {
                    ...
                    const persentaseText = parentCard ? parentCard.querySelector(
                        '.persentase-text, .total-persentase-text') : null;
                    ...
                    entries.forEach(function(entry) {
                        if (entry.isIntersecting) {
                            ...
                            progressBars.forEach(bar => {
                                bar.style.width = '0%';
                                const text = bar.closest('.custom-card, .total-card')
                                    .querySelector(
                                        '.persentase-text, .total-persentase-text');
