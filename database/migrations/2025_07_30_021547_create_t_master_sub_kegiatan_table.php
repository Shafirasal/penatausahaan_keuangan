...
return new class extends Migration
{
    ...
    {
        Schema::create('t_master_sub_kegiatan', function (Blueprint $table) {
            $table->increments('id_sub_kegiatan'); // id_sub_kegiatan as auto-increment primary key
            ...
            $table->string('nama_sub_kegiatan', 200); 
    ...
    {
        Schema::dropIfExists('t_master_sub_kegiatan');
    }
};
